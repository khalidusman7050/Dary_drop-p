...
if($num_of_rows==0){
  echo"<h2 class='text-center text-danger'>This brand is not avalibale for service</h2>";
}
...
while($row=mysqli_fetch_assoc($result_query)){
  ...
  echo "<div class='col-md-4 mb-2'>
    ...
    //display the brand in sidenav
    function getbrands(){
        global $con;
         $select_brands = "select * from `brands`";
      $result_brads=mysqli_query($con,$select_brands);
      //$row_data=mysqli_fetch_assoc($result_brads);
      //echo $row_data['brand_title'];
      while($row_data=mysqli_fetch_assoc($result_brads)){
...
if($num_of_rows==0){
  echo"<h2 class='text-center text-danger'>No result found for this search</h2>";
}
          ...
          if(!isset($_GET['my_orders'])){
            if(!isset($_GET['delete_account'])){
              ...
              if($row_count>0){
                ...
                <p class='text-center'><a href='profile.php?my_orders' class='btn btn-info'>Order details</a></p>";
              }else{
